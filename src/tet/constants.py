...
"""
plotting_params: A dictionary that defines a set of parameters used for the PlotResults class 
in the data_process.py file.
Documentation:
    *plotting_params:The num parameter in np.linspace. Given the limits of a trainable parameter, it determines in how many points
    * will you split the interval
"""
