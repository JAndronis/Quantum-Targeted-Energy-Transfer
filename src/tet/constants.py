...
Documentation:
    ...
    * train_sites: A list including the nonlinearity parameters to be optimized. Counting 
    * ranges from 0 to f-1.
"""
...
Documentation:
    ...
    * Npoints: The num parameter in np.linspace. Given the limits of a trainable parameter, it determines the desnsity of 
    * the 1D grid.
...
# -------------------------------------------------------------------#
"""
dumpConstants: Function that generates a json file from the dictionary provided.
"""
...
# -------------------------------------------------------------------#
"""
loadConstants: Function that loads a json that was created with the dumpConstants function and writes the
